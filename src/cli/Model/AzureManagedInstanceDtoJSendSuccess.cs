...
namespace cli.Model
{
    ...
    public partial class AzureManagedInstanceDtoJSendSuccess : IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        public AzureManagedInstanceDtoJSendSuccess(AzureManagedInstanceDto data = default(AzureManagedInstanceDto))
        {
            this.Data = data;
        }
