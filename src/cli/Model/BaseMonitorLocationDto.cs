...
namespace cli.Model
{
    ...
    public partial class BaseMonitorLocationDto : IValidatableObject
    {
        /// <summary>
        ...
        public BaseMonitorLocationDto(string networkName = default(string), int portNum = default(int), string alias = default(string), bool isDisconnected = default(bool), bool isPrimary = default(bool))
        {
