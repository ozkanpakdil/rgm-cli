...
namespace cli.Model
{
    ...
    public partial class ActualPlanRuntimeMetricsDtoIEnumerableJSendSuccess : IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        public ActualPlanRuntimeMetricsDtoIEnumerableJSendSuccess(List<ActualPlanRuntimeMetricsDto> data = default(List<ActualPlanRuntimeMetricsDto>))
        {
            this.Data = data;
        }
