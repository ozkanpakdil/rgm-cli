...
namespace cli.Model
{
    ...
    public partial class AddAmazonRdsSqlServerCommandDto : IValidatableObject
    {
        ...
        public AddAmazonRdsSqlServerCommandDto(string endpoint = default(string), string username = default(string), string password = default(string), SqlServerAuthenticationMode? authenticationMode = default(SqlServerAuthenticationMode?), SqlServerConnectionPropertiesModel sqlServerConnectionProperties = default(SqlServerConnectionPropertiesModel), Guid? groupId = default(Guid?), AmazonApiCredentialsDto amazonApiCredentials = default(AmazonApiCredentialsDto), bool useBaseMonitorAccount = default(bool), string agentName = default(string))
        {
            // to ensure "endpoint" is required (not null)
            if (endpoint == null)
            {
                throw new ArgumentNullException("endpoint is a required property for AddAmazonRdsSqlServerCommandDto and cannot be null");
            }
            this.Endpoint = endpoint;
            // to ensure "sqlServerConnectionProperties" is required (not null)
            if (sqlServerConnectionProperties == null)
            {
                throw new ArgumentNullException("sqlServerConnectionProperties is a required property for AddAmazonRdsSqlServerCommandDto and cannot be null");
            }
