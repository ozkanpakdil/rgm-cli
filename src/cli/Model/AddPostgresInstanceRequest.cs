...
namespace cli.Model
{
    ...
    public partial class AddPostgresInstanceRequest : IValidatableObject
    {
        ...
        public AddPostgresInstanceRequest(string address = default(string), string alias = default(string), int port = default(int), Guid? groupId = default(Guid?), LinuxMachineConfiguration machineConfiguration = default(LinuxMachineConfiguration), PostgresInstanceCredentialsDto instanceCredentials = default(PostgresInstanceCredentialsDto), AmazonApiCredentialsDto amazonApiCredentials = default(AmazonApiCredentialsDto), AzureApiCredentialsDto azureApiCredentials = default(AzureApiCredentialsDto), string database = default(string), bool failIfExists = default(bool), EnvironmentTypeDto environmentType = default(EnvironmentTypeDto), bool addToExistingLinuxMachine = default(bool), string agentName = default(string))
        {
            // to ensure "address" is required (not null)
            if (address == null)
            {
                throw new ArgumentNullException("address is a required property for AddPostgresInstanceRequest and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("instanceCredentials is a required property for AddPostgresInstanceRequest and cannot be null");
            }
