...
public class LinuxMachineDto : IValidatableObject
{
    /// <summary>
    ...
    public LinuxMachineDto(string name = default, Guid id = default, ChannelInstanceRef cir = default,
        MonitoredObjectStateDto monitoredObjectState = default, BaseMonitorDto baseMonitor = default,
        ChannelInstanceRef entityReference = default, GroupDto group = default)
    {
        Name = name;
        Id = id;
        Cir = cir;
