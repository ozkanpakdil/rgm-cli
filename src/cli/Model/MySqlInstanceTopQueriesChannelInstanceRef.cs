...
public class MySqlInstanceTopQueriesChannelInstanceRef : IValidatableObject
{
    /// <summary>
    ...
    public MySqlInstanceTopQueriesChannelInstanceRef(ChannelRef channelRef = default, ChannelKey channelKey = default)
    {
