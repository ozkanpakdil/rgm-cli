...
{
    /// <summary>
    /// MySqlInstanceTopQueriesChannelInstanceRef
    /// </summary>
    [DataContract(Name = "MySqlInstance_TopQueriesChannelInstanceRef")]
    public partial class MySqlInstanceTopQueriesChannelInstanceRef : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MySqlInstanceTopQueriesChannelInstanceRef" /> class.
        /// </summary>
        /// <param name="channelRef">channelRef.</param>
        /// <param name="channelKey">channelKey.</param>
        public MySqlInstanceTopQueriesChannelInstanceRef(ChannelRef channelRef = default(ChannelRef), ChannelKey channelKey = default(ChannelKey))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MySqlInstanceTopQueriesChannelInstanceRef {\n");
