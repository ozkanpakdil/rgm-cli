...
public class SqlInstanceTopQueriesChannelInstanceRef : IValidatableObject
{
    /// <summary>
    ...
    public SqlInstanceTopQueriesChannelInstanceRef(ChannelRef channelRef = default, ChannelKey channelKey = default)
    {
