...
{
    /// <summary>
    /// SqlInstanceTopQueriesChannelInstanceRef
    /// </summary>
    [DataContract(Name = "_SqlInstance_TopQueriesChannelInstanceRef")]
    public partial class SqlInstanceTopQueriesChannelInstanceRef : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SqlInstanceTopQueriesChannelInstanceRef" /> class.
        /// </summary>
        /// <param name="channelRef">channelRef.</param>
        /// <param name="channelKey">channelKey.</param>
        public SqlInstanceTopQueriesChannelInstanceRef(ChannelRef channelRef = default(ChannelRef), ChannelKey channelKey = default(ChannelKey))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SqlInstanceTopQueriesChannelInstanceRef {\n");
