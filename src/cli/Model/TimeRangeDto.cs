...
public class TimeRangeDto : IValidatableObject
{
    /// <summary>
    ...
    public TimeRangeDto(AlertsFilterTimeRangeTypeDto? type = default, int relativeMinutes = default,
        long? fromDateTime = default, long? toDateTime = default,
        AlertsFilterTimeWindowModesDto? timeWindowMode = default)
    {
        Type = type;
