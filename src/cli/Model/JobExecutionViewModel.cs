...
namespace cli.Model
{
    ...
    public partial class JobExecutionViewModel : IValidatableObject
    {
        /// <summary>
        ...
        public JobExecutionViewModel(string category = default(string), string name = default(string), string description = default(string), int executionCount = default(int), int successCount = default(int), int failureCount = default(int), DateTime? nextRun = default(DateTime?), JobExecutionResultDto lastRun = default(JobExecutionResultDto))
        {
