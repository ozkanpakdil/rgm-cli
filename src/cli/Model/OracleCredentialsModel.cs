...
public class OracleCredentialsModel : IValidatableObject
{
    /// <summary>
    ...
    public OracleCredentialsModel(string userName = default, string password = default, bool decryptionFailed = default,
        OracleAuthenticationMode? authenticationMode = default)
    {
        UserName = userName;
        Password = password;
