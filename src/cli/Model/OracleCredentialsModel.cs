...
namespace cli.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OracleCredentialsModel")]
    public partial class OracleCredentialsModel : IValidatableObject
    {
        ...
        public OracleAuthenticationMode? AuthenticationMode { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="OracleCredentialsModel" /> class.
        /// </summary>
        /// <param name="userName">userName.</param>
        /// <param name="password">password.</param>
        /// <param name="decryptionFailed">decryptionFailed.</param>
        /// <param name="authenticationMode">authenticationMode.</param>
        public OracleCredentialsModel(string userName = default(string), string password = default(string), bool decryptionFailed = default(bool), OracleAuthenticationMode? authenticationMode = default(OracleAuthenticationMode?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OracleCredentialsModel {\n");
