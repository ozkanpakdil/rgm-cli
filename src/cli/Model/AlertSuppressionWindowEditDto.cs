...
public class AlertSuppressionWindowEditDto : IValidatableObject
{
    /// <summary>
    ...
    public AlertSuppressionWindowEditDto(ScheduleFrequencyDto? scheduleFrequency = default,
        IntegerIdentifier id = default, string name = default, string start = default, int? duration = default,
        ...
        DayOfWeek? monthlyScheduleDayOfWeek = default, List<AlertSuppressionTargetEditDto> targets = default)
    {
