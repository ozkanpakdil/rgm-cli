...
namespace cli.Model
{
    ...
    public partial class PostgresInstanceDatabaseChannelInstanceRef : IValidatableObject
    {
        /// <summary>
        ...
        public PostgresInstanceDatabaseChannelInstanceRef(ChannelRef channelRef = default(ChannelRef), ChannelKey channelKey = default(ChannelKey))
        {
