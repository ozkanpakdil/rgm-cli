...
///     MachineInstanceDto
/// </summary>
[DataContract(Name = "MachineInstanceDto")]
public class MachineInstanceDto : IValidatableObject
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="MachineInstanceDto" /> class.
    /// </summary>
    ...
    public MachineInstanceDto(string name = default, Guid id = default, ChannelInstanceRef cir = default,
        MonitoredObjectStateDto monitoredObjectState = default, string alias = default, MachineDto machine = default,
        ChannelInstanceRef entityReference = default, List<TagDto> tags = default)
    {
        Name = name;
        Id = id;
        Cir = cir;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class MachineInstanceDto {\n");
