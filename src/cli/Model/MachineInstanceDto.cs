...
namespace cli.Model
{
    ...
    public partial class MachineInstanceDto : IValidatableObject
    {
        ...
        public MachineInstanceDto(string name = default(string), Guid id = default(Guid), ChannelInstanceRef cir = default(ChannelInstanceRef), MonitoredObjectStateDto monitoredObjectState = default(MonitoredObjectStateDto), string alias = default(string), MachineDto machine = default(MachineDto), ChannelInstanceRef entityReference = default(ChannelInstanceRef), List<TagDto> tags = default(List<TagDto>))
        {
            this.Name = name;
            this.Id = id;
            this.Cir = cir;
