...
public class MySqlInstanceChannelInstanceRef : IValidatableObject
{
    /// <summary>
    ...
    public MySqlInstanceChannelInstanceRef(ChannelRef channelRef = default, ChannelKey channelKey = default)
    {
