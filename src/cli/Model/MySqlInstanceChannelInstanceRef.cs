...
namespace cli.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MySqlInstanceChannelInstanceRef")]
    public partial class MySqlInstanceChannelInstanceRef : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MySqlInstanceChannelInstanceRef" /> class.
        /// </summary>
        /// <param name="channelRef">channelRef.</param>
        /// <param name="channelKey">channelKey.</param>
        public MySqlInstanceChannelInstanceRef(ChannelRef channelRef = default(ChannelRef), ChannelKey channelKey = default(ChannelKey))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MySqlInstanceChannelInstanceRef {\n");
