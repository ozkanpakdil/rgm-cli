...
public class ClusterInstanceDto : IValidatableObject
{
    /// <summary>
    ...
    public ClusterInstanceDto(string name = default, Guid id = default, ChannelInstanceRef cir = default,
        MonitoredObjectStateDto monitoredObjectState = default, string alias = default, ClusterDto cluster = default,
        ChannelInstanceRef entityReference = default, List<TagDto> tags = default, string virtualInstanceName = default)
    {
        Name = name;
        Id = id;
        Cir = cir;
