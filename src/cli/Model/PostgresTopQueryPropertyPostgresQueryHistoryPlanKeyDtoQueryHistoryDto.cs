...
public class PostgresTopQueryPropertyPostgresQueryHistoryPlanKeyDtoQueryHistoryDto : IValidatableObject
{
    /// <summary>
    ///     Initializes a new instance of the
    ///     <see cref="PostgresTopQueryPropertyPostgresQueryHistoryPlanKeyDtoQueryHistoryDto" /> class.
    /// </summary>
    ...
    public PostgresTopQueryPropertyPostgresQueryHistoryPlanKeyDtoQueryHistoryDto(DateTime minTime = default,
        DateTime maxTime = default, List<PostgresTopQueryPropertyQueryHistorySeriesDto> queryHistorySeries = default,
        List<PostgresQueryHistoryPlanKeyDtoQueryHistoryPlanChangePointDto> planChanges = default)
    {
        MinTime = minTime;
        MaxTime = maxTime;
