...
namespace cli.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MongoDbInstanceChannelInstanceRef")]
    public partial class MongoDbInstanceChannelInstanceRef : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MongoDbInstanceChannelInstanceRef" /> class.
        /// </summary>
        /// <param name="channelRef">channelRef.</param>
        /// <param name="channelKey">channelKey.</param>
        public MongoDbInstanceChannelInstanceRef(ChannelRef channelRef = default(ChannelRef), ChannelKey channelKey = default(ChannelKey))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MongoDbInstanceChannelInstanceRef {\n");
