...
public class MongoDbInstanceChannelInstanceRef : IValidatableObject
{
    /// <summary>
    ...
    public MongoDbInstanceChannelInstanceRef(ChannelRef channelRef = default, ChannelKey channelKey = default)
    {
