...
///     AzureSqlServerDto
/// </summary>
[DataContract(Name = "AzureSqlServerDto")]
public class AzureSqlServerDto : IValidatableObject
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="AzureSqlServerDto" /> class.
    /// </summary>
    ...
    public AzureSqlServerDto(string name = default, Guid id = default, ChannelInstanceRef cir = default,
        GroupDto group = default, MonitoredObjectStateDto monitoredObjectState = default,
        BaseMonitorDto baseMonitor = default, bool autoDiscoveryEnabled = default)
    {
        Name = name;
        Id = id;
        Cir = cir;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class AzureSqlServerDto {\n");
