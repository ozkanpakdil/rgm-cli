...
public class SqlInstanceIndexesChannelInstanceRef : IValidatableObject
{
    /// <summary>
    ...
    public SqlInstanceIndexesChannelInstanceRef(ChannelRef channelRef = default, ChannelKey channelKey = default)
    {
