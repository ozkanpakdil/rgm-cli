...
{
    /// <summary>
    /// SqlInstanceIndexesChannelInstanceRef
    /// </summary>
    [DataContract(Name = "_SqlInstance_IndexesChannelInstanceRef")]
    public partial class SqlInstanceIndexesChannelInstanceRef : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SqlInstanceIndexesChannelInstanceRef" /> class.
        /// </summary>
        /// <param name="channelRef">channelRef.</param>
        /// <param name="channelKey">channelKey.</param>
        public SqlInstanceIndexesChannelInstanceRef(ChannelRef channelRef = default(ChannelRef), ChannelKey channelKey = default(ChannelKey))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SqlInstanceIndexesChannelInstanceRef {\n");
