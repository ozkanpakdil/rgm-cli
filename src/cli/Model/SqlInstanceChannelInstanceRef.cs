...
namespace cli.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_SqlInstanceChannelInstanceRef")]
    public partial class SqlInstanceChannelInstanceRef : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SqlInstanceChannelInstanceRef" /> class.
        /// </summary>
        /// <param name="channelRef">channelRef.</param>
        /// <param name="channelKey">channelKey.</param>
        public SqlInstanceChannelInstanceRef(ChannelRef channelRef = default(ChannelRef), ChannelKey channelKey = default(ChannelKey))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SqlInstanceChannelInstanceRef {\n");
