...
public class SqlInstanceChannelInstanceRef : IValidatableObject
{
    /// <summary>
    ...
    public SqlInstanceChannelInstanceRef(ChannelRef channelRef = default, ChannelKey channelKey = default)
    {
