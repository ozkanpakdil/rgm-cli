...
namespace cli.Model
{
    ...
    public partial class LinuxMachineCredentialsModel : IValidatableObject
    {
        ...
        public LinuxMachineCredentialsModel(string userName = default(string), string password = default(string), bool decryptionFailed = default(bool), SshAuthenticationTypeDto? sshAuthenticationType = default(SshAuthenticationTypeDto?), string sshPrivateKeyId = default(string))
        {
