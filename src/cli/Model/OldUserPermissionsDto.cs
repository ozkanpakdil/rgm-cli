...
namespace cli.Model
{
    ...
    public partial class OldUserPermissionsDto : IValidatableObject
    {
        /// <summary>
        ...
        public OldUserPermissionsDto(string name = default(string), string accountName = default(string), string sid = default(string), int sysAdmins = default(int), int serverAdmins = default(int), int securityAdmins = default(int), int totalServers = default(int), int dbOwners = default(int), int dbAccessAdmins = default(int), int dbSecurityAdmins = default(int), int totalDatabases = default(int), List<OldServerLoginPermissionsDto> serverLoginPermissions = default(List<OldServerLoginPermissionsDto>), List<OldServerDatabasePermissionsDto> serverDatabasePermissions = default(List<OldServerDatabasePermissionsDto>))
        {
            this.Name = name;
            ...
            this.SecurityAdmins = securityAdmins;
            this.TotalServers = totalServers;
            this.DbOwners = dbOwners;
            this.DbAccessAdmins = dbAccessAdmins;
            this.DbSecurityAdmins = dbSecurityAdmins;
            this.TotalDatabases = totalDatabases;
            this.ServerLoginPermissions = serverLoginPermissions;
            this.ServerDatabasePermissions = serverDatabasePermissions;
        }
