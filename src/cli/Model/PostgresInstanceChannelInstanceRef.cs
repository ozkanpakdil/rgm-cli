...
public class PostgresInstanceChannelInstanceRef : IValidatableObject
{
    /// <summary>
    ...
    public PostgresInstanceChannelInstanceRef(ChannelRef channelRef = default, ChannelKey channelKey = default)
    {
