...
namespace cli.Model
{
    ...
    public partial class StandaloneMachineDto : IValidatableObject
    {
        ...
        public StandaloneMachineDto(string name = default(string), Guid id = default(Guid), ChannelInstanceRef cir = default(ChannelInstanceRef), MonitoredObjectStateDto monitoredObjectState = default(MonitoredObjectStateDto), BaseMonitorDto baseMonitor = default(BaseMonitorDto), GroupDto group = default(GroupDto))
        {
            this.Name = name;
            this.Id = id;
            this.Cir = cir;
