...
namespace cli.Model
{
    ...
    public partial class MonitoredEntityDto : IValidatableObject
    {
        ...
        public MonitoredEntityDto(string id = default(string), string displayName = default(string), TypeEnum? type = default(TypeEnum?), string fullyQualifiedName = default(string), string group = default(string), MonitoredEntitySeverity? monitoringStatus = default(MonitoredEntitySeverity?), string parentId = default(string))
        {
            this.Id = id;
