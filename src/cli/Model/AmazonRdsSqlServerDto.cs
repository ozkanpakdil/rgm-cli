...
namespace cli.Model
{
    ...
    public partial class AmazonRdsSqlServerDto : IValidatableObject
    {
        ...
        public AmazonRdsSqlServerDto(string name = default(string), Guid id = default(Guid), ChannelInstanceRef cir = default(ChannelInstanceRef), GroupDto group = default(GroupDto), MonitoredObjectStateDto monitoredObjectState = default(MonitoredObjectStateDto), BaseMonitorDto baseMonitor = default(BaseMonitorDto), string alias = default(string), ChannelInstanceRef entityReference = default(ChannelInstanceRef), List<TagDto> tags = default(List<TagDto>))
        {
            this.Name = name;
            this.Id = id;
            this.Cir = cir;
