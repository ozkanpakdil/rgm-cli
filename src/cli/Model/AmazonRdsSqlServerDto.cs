...
/// </summary>
[DataContract(Name = "AmazonRdsSqlServerDto")]
public class AmazonRdsSqlServerDto : IValidatableObject
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="AmazonRdsSqlServerDto" /> class.
    /// </summary>
    ...
    public AmazonRdsSqlServerDto(string name = default, Guid id = default, ChannelInstanceRef cir = default,
        GroupDto group = default, MonitoredObjectStateDto monitoredObjectState = default,
        BaseMonitorDto baseMonitor = default, string alias = default, ChannelInstanceRef entityReference = default,
    ...
    public override string ToString()
    {
        ...
        sb.Append("class AmazonRdsSqlServerDto {\n");
