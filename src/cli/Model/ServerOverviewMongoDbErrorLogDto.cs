...
namespace cli.Model
{
    ...
    public partial class ServerOverviewMongoDbErrorLogDto : IValidatableObject
    {
        /// <summary>
        ...
        public ServerOverviewMongoDbErrorLogDto(List<MongoDbErrorLogDto> errorLogs = default(List<MongoDbErrorLogDto>), int total = default(int))
        {
