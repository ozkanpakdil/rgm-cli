...
namespace cli.Model
{
    ...
    public partial class WindowsMachineCredentialsModel : IValidatableObject
    {
        /// <summary>
        ...
        public WindowsMachineCredentialsModel(bool isBaseMonitorAccount = default(bool), string userName = default(string), string password = default(string), bool decryptionFailed = default(bool))
        {
