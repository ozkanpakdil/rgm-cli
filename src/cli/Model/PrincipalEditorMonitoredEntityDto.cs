...
public class PrincipalEditorMonitoredEntityDto : IValidatableObject
{
    /// <summary>
    ...
    public PrincipalEditorMonitoredEntityDto(string name = default, ChannelInstanceRef cir = default,
        bool? selected = default, PrincipalEditorEntityTypeDto? entityType = default, string baseMonitorName = default,
        List<PrincipalEditorMonitoredEntityDto> childEntities = default)
    {
        Name = name;
        Cir = cir;
        Selected = selected;
