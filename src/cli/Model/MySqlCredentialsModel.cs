...
public class MySqlCredentialsModel : IValidatableObject
{
    /// <summary>
    ...
    public MySqlCredentialsModel(string userName = default, string password = default, bool decryptionFailed = default,
        MySqlAuthenticationMode? authenticationMode = default)
    {
        UserName = userName;
        Password = password;
