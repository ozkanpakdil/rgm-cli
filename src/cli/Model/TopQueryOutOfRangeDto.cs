...
namespace cli.Model
{
    ...
    public partial class TopQueryOutOfRangeDto : IValidatableObject
    {
        /// <summary>
        ...
        public TopQueryOutOfRangeDto(ChannelInstanceRef channelInstanceRef = default(ChannelInstanceRef), FullQueryTextDto queryText = default(FullQueryTextDto), string queryHash = default(string), string database = default(string))
        {
