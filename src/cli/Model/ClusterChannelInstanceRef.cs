...
namespace cli.Model
{
    ...
    public partial class ClusterChannelInstanceRef : IValidatableObject
    {
        /// <summary>
        ...
        public ClusterChannelInstanceRef(ChannelRef channelRef = default(ChannelRef), ChannelKey channelKey = default(ChannelKey))
        {
