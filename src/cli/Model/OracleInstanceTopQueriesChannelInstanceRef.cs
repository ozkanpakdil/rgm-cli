...
{
    /// <summary>
    /// OracleInstanceTopQueriesChannelInstanceRef
    /// </summary>
    [DataContract(Name = "OracleInstance_TopQueriesChannelInstanceRef")]
    public partial class OracleInstanceTopQueriesChannelInstanceRef : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OracleInstanceTopQueriesChannelInstanceRef" /> class.
        /// </summary>
        /// <param name="channelRef">channelRef.</param>
        /// <param name="channelKey">channelKey.</param>
        public OracleInstanceTopQueriesChannelInstanceRef(ChannelRef channelRef = default(ChannelRef), ChannelKey channelKey = default(ChannelKey))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OracleInstanceTopQueriesChannelInstanceRef {\n");
