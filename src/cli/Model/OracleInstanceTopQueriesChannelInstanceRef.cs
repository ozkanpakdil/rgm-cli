...
public class OracleInstanceTopQueriesChannelInstanceRef : IValidatableObject
{
    /// <summary>
    ...
    public OracleInstanceTopQueriesChannelInstanceRef(ChannelRef channelRef = default, ChannelKey channelKey = default)
    {
