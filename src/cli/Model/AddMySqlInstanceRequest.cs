...
public class AddMySqlInstanceRequest : IValidatableObject
{
    /// <summary>
    ...
    public AddMySqlInstanceRequest(string address = default, string alias = default, int port = default,
        Guid? groupId = default, string agentName = default, LinuxMachineConfiguration machineConfiguration = default,
        MySqlInstanceCredentialsDto instanceCredentials = default, bool failIfExists = default,
        bool addToExistingLinuxMachine = default)
    {
        // to ensure "address" is required (not null)
        if (address == null)
            throw new ArgumentNullException(
                "address is a required property for AddMySqlInstanceRequest and cannot be null");
        Address = address;
        Port = port;
        // to ensure "instanceCredentials" is required (not null)
        if (instanceCredentials == null)
            throw new ArgumentNullException(
                "instanceCredentials is a required property for AddMySqlInstanceRequest and cannot be null");
