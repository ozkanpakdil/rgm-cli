...
{
    /// <summary>
    /// SqlInstanceAgentJobChannelInstanceRef
    /// </summary>
    [DataContract(Name = "_SqlInstance_Agent_JobChannelInstanceRef")]
    public partial class SqlInstanceAgentJobChannelInstanceRef : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SqlInstanceAgentJobChannelInstanceRef" /> class.
        /// </summary>
        /// <param name="channelRef">channelRef.</param>
        /// <param name="channelKey">channelKey.</param>
        public SqlInstanceAgentJobChannelInstanceRef(ChannelRef channelRef = default(ChannelRef), ChannelKey channelKey = default(ChannelKey))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SqlInstanceAgentJobChannelInstanceRef {\n");
