...
public class SqlInstanceAgentJobChannelInstanceRef : IValidatableObject
{
    /// <summary>
    ...
    public SqlInstanceAgentJobChannelInstanceRef(ChannelRef channelRef = default, ChannelKey channelKey = default)
    {
