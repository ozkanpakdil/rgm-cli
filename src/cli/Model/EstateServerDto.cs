...
namespace cli.Model
{
    ...
    public partial class EstateServerDto : IValidatableObject
    {
        /// <summary>
        ...
        public EstateServerDto(string cir = default(string), string fullyQualifiedName = default(string), string clusterName = default(string), string displayName = default(string), string alias = default(string), List<TagDto> tags = default(List<TagDto>))
        {
            this.Cir = cir;
