...
public class MonitoredObjectWithIdDto : IValidatableObject
{
    /// <summary>
    ...
    public MonitoredObjectWithIdDto(string name = default, Guid id = default, ChannelInstanceRef cir = default)
    {
        Name = name;
        Id = id;
        Cir = cir;
