...
namespace cli.Model
{
    ...
    public partial class ParsedRelOpDto : IValidatableObject
    {
        /// <summary>
        ...
        public ParsedRelOpDto(IntegerIdentifier id = default(IntegerIdentifier), string name = default(string), double estimatedRows = default(double), double actualRows = default(double), double difference = default(double), double cost = default(double))
        {
