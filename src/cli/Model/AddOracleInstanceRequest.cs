...
namespace cli.Model
{
    ...
    public partial class AddOracleInstanceRequest : IValidatableObject
    {
        /// <summary>
        ...
        public AddOracleInstanceRequest(string address = default(string), string alias = default(string), int port = default(int), string serviceName = default(string), Guid? groupId = default(Guid?), string agentName = default(string), LinuxMachineConfiguration machineConfiguration = default(LinuxMachineConfiguration), OracleInstanceCredentialsDto instanceCredentials = default(OracleInstanceCredentialsDto), bool failIfExists = default(bool), bool addToExistingLinuxMachine = default(bool), bool useTcps = default(bool))
        {
            // to ensure "address" is required (not null)
            if (address == null)
            {
                throw new ArgumentNullException("address is a required property for AddOracleInstanceRequest and cannot be null");
            }
            ...
            if (serviceName == null)
            {
                throw new ArgumentNullException("serviceName is a required property for AddOracleInstanceRequest and cannot be null");
            }
            this.ServiceName = serviceName;
            // to ensure "instanceCredentials" is required (not null)
            if (instanceCredentials == null)
            {
                throw new ArgumentNullException("instanceCredentials is a required property for AddOracleInstanceRequest and cannot be null");
            }
        ...
        IEnumerable<ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Invalid value for ServiceName, length must be greater than 1.", new [] { "ServiceName" });
            }
