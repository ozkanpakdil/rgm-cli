...
namespace cli.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AddMongoDbInstanceRequest")]
    public partial class AddMongoDbInstanceRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddMongoDbInstanceRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AddMongoDbInstanceRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AddMongoDbInstanceRequest" /> class.
        /// </summary>
        ...
        public AddMongoDbInstanceRequest(string address = default(string), string alias = default(string), int port = default(int), Guid? groupId = default(Guid?), string agentName = default(string), LinuxMachineConfiguration machineConfiguration = default(LinuxMachineConfiguration), MongoDbInstanceCredentialsDto instanceCredentials = default(MongoDbInstanceCredentialsDto), bool failIfExists = default(bool), bool addToExistingLinuxMachine = default(bool))
        {
            // to ensure "address" is required (not null)
            if (address == null)
            {
                throw new ArgumentNullException("address is a required property for AddMongoDbInstanceRequest and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("instanceCredentials is a required property for AddMongoDbInstanceRequest and cannot be null");
            }
        ...
        public MongoDbInstanceCredentialsDto InstanceCredentials { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddMongoDbInstanceRequest {\n");
