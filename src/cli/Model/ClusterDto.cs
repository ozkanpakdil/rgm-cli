...
namespace cli.Model
{
    ...
    /// ClusterDto
    /// </summary>
    [DataContract(Name = "ClusterDto")]
    public partial class ClusterDto : IValidatableObject
    {
        ...
        public ClusterDto(string name = default(string), Guid id = default(Guid), ChannelInstanceRef cir = default(ChannelInstanceRef), GroupDto group = default(GroupDto), MonitoredObjectStateDto monitoredObjectState = default(MonitoredObjectStateDto), BaseMonitorDto baseMonitor = default(BaseMonitorDto))
        {
            this.Name = name;
            this.Id = id;
            this.Cir = cir;
