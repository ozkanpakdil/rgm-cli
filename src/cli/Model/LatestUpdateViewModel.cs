...
namespace cli.Model
{
    ...
    public partial class LatestUpdateViewModel : IValidatableObject
    {
        /// <summary>
        ...
        public LatestUpdateViewModel(string productLevel = default(string), string downloadUrl = default(string), string servicePackDownloadUrl = default(string), DateTime releaseDate = default(DateTime), string versionNumber = default(string))
        {
            this.ProductLevel = productLevel;
            this.DownloadUrl = downloadUrl;
            this.ServicePackDownloadUrl = servicePackDownloadUrl;
