...
public class OracleInstanceChannelInstanceRef : IValidatableObject
{
    /// <summary>
    ...
    public OracleInstanceChannelInstanceRef(ChannelRef channelRef = default, ChannelKey channelKey = default)
    {
