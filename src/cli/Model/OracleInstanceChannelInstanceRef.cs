...
namespace cli.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OracleInstanceChannelInstanceRef")]
    public partial class OracleInstanceChannelInstanceRef : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OracleInstanceChannelInstanceRef" /> class.
        /// </summary>
        /// <param name="channelRef">channelRef.</param>
        /// <param name="channelKey">channelKey.</param>
        public OracleInstanceChannelInstanceRef(ChannelRef channelRef = default(ChannelRef), ChannelKey channelKey = default(ChannelKey))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OracleInstanceChannelInstanceRef {\n");
