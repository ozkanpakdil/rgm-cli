...
public class AzureCredentialsModel : IValidatableObject
{
    /// <summary>
    ...
    public AzureCredentialsModel(string userName = default, string password = default, bool decryptionFailed = default,
        AzureAuthenticationMode? authenticationMode = default)
    {
        UserName = userName;
        Password = password;
