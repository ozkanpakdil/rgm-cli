...
namespace cli.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AzureCredentialsModel")]
    public partial class AzureCredentialsModel : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AzureCredentialsModel" /> class.
        /// </summary>
        /// <param name="userName">userName.</param>
        /// <param name="password">password.</param>
        /// <param name="decryptionFailed">decryptionFailed.</param>
        /// <param name="authenticationMode">authenticationMode.</param>
        public AzureCredentialsModel(string userName = default(string), string password = default(string), bool decryptionFailed = default(bool), AzureAuthenticationMode? authenticationMode = default(AzureAuthenticationMode?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AzureCredentialsModel {\n");
