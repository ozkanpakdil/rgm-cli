...
public class HostedSqlServerInstanceDto : IValidatableObject
{
    /// <summary>
    ...
    public HostedSqlServerInstanceDto(string name = default, Guid id = default, ChannelInstanceRef cir = default,
        MonitoredObjectStateDto monitoredObjectState = default, LinuxMachineDto machine = default,
        ChannelInstanceRef entityReference = default, string alias = default, BaseMonitorDto baseMonitor = default,
