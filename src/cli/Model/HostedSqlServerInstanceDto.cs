...
namespace cli.Model
{
    ...
    /// </summary>
    [DataContract(Name = "HostedSqlServerInstanceDto")]
    public partial class HostedSqlServerInstanceDto : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HostedSqlServerInstanceDto" /> class.
        /// </summary>
        ...
        public HostedSqlServerInstanceDto(string name = default(string), Guid id = default(Guid), ChannelInstanceRef cir = default(ChannelInstanceRef), MonitoredObjectStateDto monitoredObjectState = default(MonitoredObjectStateDto), LinuxMachineDto machine = default(LinuxMachineDto), ChannelInstanceRef entityReference = default(ChannelInstanceRef), string alias = default(string), BaseMonitorDto baseMonitor = default(BaseMonitorDto), List<TagDto> tags = default(List<TagDto>))
        {
            this.Name = name;
            this.Id = id;
            this.Cir = cir;
        ...
        public LinuxMachineDto Machine { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HostedSqlServerInstanceDto {\n");
