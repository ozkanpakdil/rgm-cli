...
public class IndexesTableItemDto : IValidatableObject
{
    /// <summary>
    ...
    public IndexesTableItemDto(SqlInstanceIndexesChannelInstanceRef indexCir = default,
        string parentObjectName = default, string databaseName = default, string name = default,
        long? sizeUsedKb = default, long updates = default, long seeks = default, long scans = default,
        long lookups = default, DateTime? lastUsed = default, IndexTypeDto? indexType = default,
        bool isUnique = default, IndexStatusDto? status = default)
    {
        IndexCir = indexCir;
