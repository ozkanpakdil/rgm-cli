...
namespace cli.Model
{
    ...
    public partial class ActualPlanRuntimeMetricsDto : IValidatableObject
    {
        /// <summary>
        ...
        public ActualPlanRuntimeMetricsDto(DateTime collectionDate = default(DateTime), DateTime createDate = default(DateTime), string planHandle = default(string), ParsedRelOpDto mostExpensiveOperation = default(ParsedRelOpDto))
        {
            this.CollectionDate = collectionDate;
            this.CreateDate = createDate;
            this.PlanHandle = planHandle;
            this.MostExpensiveOperation = mostExpensiveOperation;
        }
