...
namespace cli.Model
{
    ...
    public partial class ServerConfigResult : IValidatableObject
    {
        /// <summary>
        ...
        public ServerConfigResult(string clusterName = default(string), string sqlServerVersion = default(string), string edition = default(string), string collation = default(string), string varOperatingSystem = default(string), string memory = default(string), string clustered = default(string), string virtualized = default(string), string monitoring = default(string), string monitoringClass = default(string), string availability = default(string), string lastRestart = default(string), string integration = default(string), string browser = default(string), ServiceCountSummaryDto sqlService = default(ServiceCountSummaryDto), ServiceCountSummaryDto agent = default(ServiceCountSummaryDto), string dataUnavailableMessage = default(string))
        {
