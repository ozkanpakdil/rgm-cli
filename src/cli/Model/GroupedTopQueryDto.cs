...
public class GroupedTopQueryDto : IValidatableObject
{
    /// <summary>
    ...
    public GroupedTopQueryDto(ChannelInstanceRef channelInstanceRef = default, FullQueryTextDto queryText = default,
        ...
        List<TopQueryDto> groupedQueries = default)
    {
