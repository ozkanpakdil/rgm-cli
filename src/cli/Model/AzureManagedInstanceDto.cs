...
/// </summary>
[DataContract(Name = "AzureManagedInstanceDto")]
public class AzureManagedInstanceDto : IValidatableObject
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="AzureManagedInstanceDto" /> class.
    /// </summary>
    ...
    public AzureManagedInstanceDto(string name = default, Guid id = default, ChannelInstanceRef cir = default,
        GroupDto group = default, MonitoredObjectStateDto monitoredObjectState = default, string alias = default,
        BaseMonitorDto baseMonitor = default, ChannelInstanceRef entityReference = default, List<TagDto> tags = default)
    {
        Name = name;
        Id = id;
        Cir = cir;
    ...
    public override string ToString()
    {
        ...
        sb.Append("class AzureManagedInstanceDto {\n");
