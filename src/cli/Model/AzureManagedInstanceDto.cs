...
namespace cli.Model
{
    ...
    public partial class AzureManagedInstanceDto : IValidatableObject
    {
        ...
        public AzureManagedInstanceDto(string name = default(string), Guid id = default(Guid), ChannelInstanceRef cir = default(ChannelInstanceRef), GroupDto group = default(GroupDto), MonitoredObjectStateDto monitoredObjectState = default(MonitoredObjectStateDto), string alias = default(string), BaseMonitorDto baseMonitor = default(BaseMonitorDto), ChannelInstanceRef entityReference = default(ChannelInstanceRef), List<TagDto> tags = default(List<TagDto>))
        {
            this.Name = name;
            this.Id = id;
            this.Cir = cir;
