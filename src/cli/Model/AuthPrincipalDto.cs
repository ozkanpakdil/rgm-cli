...
public class AuthPrincipalDto : IValidatableObject
{
    /// <summary>
    ...
    public AuthPrincipalDto(string name = default, BaseMonitorDto baseMonitor = default,
        PrincipalRole? principalRole = default, PrincipalType? principalType = default, List<GroupDto> groups = default,
        List<MonitoredObjectDto> monitoredObjects = default, bool all = default,
