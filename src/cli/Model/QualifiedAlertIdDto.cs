...
namespace cli.Model
{
    ...
    public partial class QualifiedAlertIdDto : IValidatableObject
    {
        /// <summary>
        ...
        public QualifiedAlertIdDto(IntegerIdentifier alertId = default(IntegerIdentifier), string baseMonitorName = default(string))
        {
