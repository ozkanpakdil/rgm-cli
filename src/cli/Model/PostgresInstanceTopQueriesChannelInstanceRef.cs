...
{
    /// <summary>
    /// PostgresInstanceTopQueriesChannelInstanceRef
    /// </summary>
    [DataContract(Name = "PostgresInstance_TopQueriesChannelInstanceRef")]
    public partial class PostgresInstanceTopQueriesChannelInstanceRef : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostgresInstanceTopQueriesChannelInstanceRef" /> class.
        /// </summary>
        /// <param name="channelRef">channelRef.</param>
        /// <param name="channelKey">channelKey.</param>
        public PostgresInstanceTopQueriesChannelInstanceRef(ChannelRef channelRef = default(ChannelRef), ChannelKey channelKey = default(ChannelKey))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostgresInstanceTopQueriesChannelInstanceRef {\n");
