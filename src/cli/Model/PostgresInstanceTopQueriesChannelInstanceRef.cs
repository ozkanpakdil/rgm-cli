...
public class PostgresInstanceTopQueriesChannelInstanceRef : IValidatableObject
{
    /// <summary>
    ...
    public PostgresInstanceTopQueriesChannelInstanceRef(ChannelRef channelRef = default,
