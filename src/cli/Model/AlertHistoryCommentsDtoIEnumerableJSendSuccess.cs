...
namespace cli.Model
{
    ...
    public partial class AlertHistoryCommentsDtoIEnumerableJSendSuccess : IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        public AlertHistoryCommentsDtoIEnumerableJSendSuccess(List<AlertHistoryCommentsDto> data = default(List<AlertHistoryCommentsDto>))
        {
            this.Data = data;
        }
