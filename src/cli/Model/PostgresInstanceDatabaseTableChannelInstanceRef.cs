...
{
    /// <summary>
    /// PostgresInstanceDatabaseTableChannelInstanceRef
    /// </summary>
    [DataContract(Name = "PostgresInstance_Database_TableChannelInstanceRef")]
    public partial class PostgresInstanceDatabaseTableChannelInstanceRef : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostgresInstanceDatabaseTableChannelInstanceRef" /> class.
        /// </summary>
        /// <param name="channelRef">channelRef.</param>
        /// <param name="channelKey">channelKey.</param>
        public PostgresInstanceDatabaseTableChannelInstanceRef(ChannelRef channelRef = default(ChannelRef), ChannelKey channelKey = default(ChannelKey))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostgresInstanceDatabaseTableChannelInstanceRef {\n");
