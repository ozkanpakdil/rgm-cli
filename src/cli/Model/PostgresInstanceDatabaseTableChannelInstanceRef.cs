...
public class PostgresInstanceDatabaseTableChannelInstanceRef : IValidatableObject
{
    /// <summary>
    ...
    public PostgresInstanceDatabaseTableChannelInstanceRef(ChannelRef channelRef = default,
