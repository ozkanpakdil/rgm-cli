...
public class RecentAlertDetailsDto : IValidatableObject
{
    /// <summary>
    ...
    public RecentAlertDetailsDto(IntegerIdentifier alertId = default, long startTimeTicks = default,
        string status = default, string text = default, GroupOrCir alertCir = default,
        string fullAlertTypeSerialised = default, bool cleared = default, string detailsHtml = default,
        string descriptionUrl = default, List<RecentAlertCommentDto> comments = default,
        List<RecentAlertOccurrenceDto> occurrences = default)
    {
        AlertId = alertId;
