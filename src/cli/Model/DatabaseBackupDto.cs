...
public class DatabaseBackupDto : IValidatableObject
{
    /// <summary>
    ...
    public DatabaseBackupDto(EntityDto monitoredEntity = default, string groupName = default,
        string clusterName = default, string databaseName = default, string recoveryModel = default,
        LatestBackupDto latestFullBackup = default, LatestBackupDto latestLogBackup = default,
        LatestBackupDto latestDifferentialBackup = default, double maxRpoMinutes = default)
    {
        // to ensure "monitoredEntity" is required (not null)
        if (monitoredEntity == null)
            throw new ArgumentNullException(
                "monitoredEntity is a required property for DatabaseBackupDto and cannot be null");
        MonitoredEntity = monitoredEntity;
        // to ensure "groupName" is required (not null)
        if (groupName == null)
            throw new ArgumentNullException(
                "groupName is a required property for DatabaseBackupDto and cannot be null");
        GroupName = groupName;
        // to ensure "clusterName" is required (not null)
        if (clusterName == null)
            throw new ArgumentNullException(
                "clusterName is a required property for DatabaseBackupDto and cannot be null");
        ClusterName = clusterName;
        // to ensure "databaseName" is required (not null)
        if (databaseName == null)
            throw new ArgumentNullException(
                "databaseName is a required property for DatabaseBackupDto and cannot be null");
        DatabaseName = databaseName;
        // to ensure "recoveryModel" is required (not null)
        if (recoveryModel == null)
            throw new ArgumentNullException(
                "recoveryModel is a required property for DatabaseBackupDto and cannot be null");
        RecoveryModel = recoveryModel;
        // to ensure "latestFullBackup" is required (not null)
        if (latestFullBackup == null)
            throw new ArgumentNullException(
                "latestFullBackup is a required property for DatabaseBackupDto and cannot be null");
        LatestFullBackup = latestFullBackup;
        // to ensure "latestLogBackup" is required (not null)
        if (latestLogBackup == null)
            throw new ArgumentNullException(
                "latestLogBackup is a required property for DatabaseBackupDto and cannot be null");
        LatestLogBackup = latestLogBackup;
        // to ensure "latestDifferentialBackup" is required (not null)
        if (latestDifferentialBackup == null)
            throw new ArgumentNullException(
                "latestDifferentialBackup is a required property for DatabaseBackupDto and cannot be null");
        LatestDifferentialBackup = latestDifferentialBackup;
