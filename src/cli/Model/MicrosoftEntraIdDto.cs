...
namespace cli.Model
{
    ...
    public partial class MicrosoftEntraIdDto : IValidatableObject
    {
        ...
        public MicrosoftEntraIdDto(string name = default(string), Guid id = default(Guid), ChannelInstanceRef cir = default(ChannelInstanceRef), BaseMonitorDto baseMonitor = default(BaseMonitorDto))
        {
            this.Name = name;
            this.Id = id;
            this.Cir = cir;
