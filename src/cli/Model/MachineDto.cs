...
public class MachineDto : IValidatableObject
{
    /// <summary>
    ...
    public MachineDto(string name = default, Guid id = default, ChannelInstanceRef cir = default,
        MonitoredObjectStateDto monitoredObjectState = default)
    {
        Name = name;
        Id = id;
        Cir = cir;
