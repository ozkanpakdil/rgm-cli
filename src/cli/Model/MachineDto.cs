...
namespace cli.Model
{
    ...
    /// MachineDto
    /// </summary>
    [DataContract(Name = "MachineDto")]
    public partial class MachineDto : IValidatableObject
    {
        ...
        public MachineDto(string name = default(string), Guid id = default(Guid), ChannelInstanceRef cir = default(ChannelInstanceRef), MonitoredObjectStateDto monitoredObjectState = default(MonitoredObjectStateDto))
        {
            this.Name = name;
            this.Id = id;
            this.Cir = cir;
